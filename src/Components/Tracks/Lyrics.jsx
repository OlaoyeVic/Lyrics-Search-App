...
export default function Lyrics(props) {
    ...
    useEffect(() => {
       axios.get(`http://cors-access-allow.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${
       ...
       .then(res => {
        ...
        return axios.get(`https://cors-access-allow.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.get?track_id=${
          props.match.params.id
        }&apikey=${process.env.REACT_APP_MM_KEY}`)
       })
